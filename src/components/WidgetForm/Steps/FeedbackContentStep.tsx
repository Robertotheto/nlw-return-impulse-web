    ...
    <>
      ...
      <form onSubmit={handleSubmitFeedback} className="my-4 w-full">
        <textarea
          ...
          placeholder-zinc-400 text-zinc-100 border-zinc-600 rounded-lg
          bg-transparent focus:border-brand-500 focus:ring-brand-500 
          focus:ring-1 resize-none scrollbar scrollbar-thingy
